...
возвращает страну с самым длинным названием(затем страну с самым 
коротким названием) */
 ...
 let countries = [
    ...
    function LCountry(cntry){
        let sortArr = cntry.sort(function(a,b){
            return a.length - b.length;
        })
        return sortcntry.pop()
    }
    ...
    function SCountry(chtry){
        let sortcntry = cntry.sort(function(a,b){
